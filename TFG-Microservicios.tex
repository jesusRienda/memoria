...
\chapter{Introducción}
	...
	En cuanto a base de datos hemos elegido PostgreSQL ya que es open source y totalmente compatible con muchos lenguajes de programación, no solo con Java que es el caso de nuestra aplicación, sino que si en un futuro creamos otro microservicio con python y queremos reutilizar la base de datos esta nos servirá.

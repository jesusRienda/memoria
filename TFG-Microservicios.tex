...
\section{Frameworks}
 Otra opción para no diseñar nuestra arquitectura desde cero sería usar frameworks, son estructuras de software ya implementadas mediante las que un programador puede apoyarse para desarrollar un proyecto propio. Estos frameworks están implementados siguiendo los patrones de sotfware y los patrones de arquitectura, suelen incluir ficheros de configuración, librerías.
 
 Existen frameworks de prácticamente todos los lenguajes de programación, con ellos te olvidas de crear una arquitectura tal y como hemos visto hasta ahora y solo tienes que implementar los requisitos funcionales de tu producto, eso si es importante valorar y elegir el framework que se adapta a tu problema.

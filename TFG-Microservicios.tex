...
Para este proyecto necesitamos a un arquitecto de sistemas para realizar el diseño de la arquitectura que vamos a utilizar, también necesitamos a un desarrollador para la implementación.

El coste por hora se ha calculado dividiendo el salario bruto anual entre 12 meses, el mensual entre 4 semanas y este entre 40 horas semanales.

\begin{table}[H]
	\begin{center}
		\begin{tabular}{|l|l|l|l|l|}
			\hline
			Empleo & Salario anual(euros) & Coste Hora(euros) & Horas & Total(euros) \\
			\hline \hline
			Arquitecto de sistemas & 45000 & 23,44 & 150 & 3516 \\ \hline
			Desarrollador web & 28000 & 14,58 & 100 & 1458,33 \\ \hline
			Mano de obra total & & & & 4974,33 \\ \hline
		\end{tabular}
...
Hemos necesitado recurrir a una nube de desarrollo donde almacenar nuestra base de datos y para ello hemos utilizado Microssof Azure
